    ...
    return (
        <Provider reCaptchaKey={process.env.CAPTCHAKEY}>
            ...
            <div className="mt-[1.2rem] md:mt-[9rem] w-[95%] mx-auto md:w-[60%]">
                ...
                <p></p>
                <h5>Zamena za drugi artikal</h5>
                <p>
                    Uslov da izvr&scaron;ite zamenu artikla je da cena zamenskog artikla
                    bude ista ili veća od cene artikla koji želite da zamenite.
                    <br />
                    Da biste realizovali zamenu, molimo Vas da nas kontaktirate putem
                    forme ispod.
                </p>
                <p>
