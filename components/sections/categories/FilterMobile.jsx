    ...
    return (
        <>
            <div className="h-full flex flex-col">
                ...
                >
                    <h1 className="text-[#171717] self-center mx-auto font-light text-center text-[1.44rem]">
                        Filteri
                    </h1>
                    <i
                ...
                <div className="flex w-[95%] mx-auto flex-col border-b border-b-[#f5f5f5] py-[23px] overflow-hidden">
                    ...
                    >
                        <h1 className="text-[1.2rem] font-light">Sortiranje</h1>
                    ...
                    return (
                        <div key={index}>
                            <div
                                ...
                                key={filter?.key}
                            >
                                <h1 className="text-[1.2rem] font-light">
