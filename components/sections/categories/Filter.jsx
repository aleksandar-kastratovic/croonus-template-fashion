            ...
            {(filter?.params?.items ?? []).slice(0, filterNumber).map((item) => (
                <div key={item.id}>
                    ...
                    >
                        <input
                            type="checkbox"
                            className="h-4 w-4 rounded-sm bg-[#f2f2f2] text-black border-[#f2f2f2]  focus:ring-0"
                            name={item.label}
                        ...
                        />
                        <label
                            className="text-[0.875rem] font-normal leading-[1.625rem]"
    ...
    return (
        <>
            ...
            <div className={classes.valueHolder}>
                <span className={`md:text-[0.9rem] max-md:text-[1.2rem] font-light`}>
                    od: {selectedValue[0]}
                </span>
                <span className={`md:text-[0.9rem] max-md:text-[1.2rem] font-light`}>
                    {" "}
