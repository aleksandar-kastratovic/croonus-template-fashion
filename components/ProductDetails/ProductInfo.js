    ...
    <>
      <div className="max-md:col-span-4 mt-[2rem] md:col-span-2 ">
        ...
        <div className="mt-[4.188rem] flex items-center gap-[31px] ">
          <button
            disabled={productVariant === null || productVariant.length === 0}
            className={
              productVariant === null || productVariant.length === 0
        ...
        <div className="fixed max-w-[114px] right-0 top-[30%] flex flex-col gap-[30px] px-5 py-[37px] bg-white drop-shadow-2xl rounded-l-lg">
          ...
          <div className="flex flex-col items-center text-center justify-center">
            <Image src={Calendar} alt="free delivery" width={47} height={42} />
        ...
        >
          ...
          <div className="mt-[4.375rem]">
            <p className="font-light text-[15px]">
              ...
              Republike Srbije. Isporuku proizvoda poručenih na sajtu pazari.rs
              vrši kurirska služba „YU – PD Express“ d.o.o . Beograd – D
              Express, na teritoriji Republike Srbije, radnim danima u periodu
              od 8 do 16h, na adresu primaoca pošiljke.
            </p>
            <p className="font-light mt-[30px] text-[15px]">
              ...
              porudžbinu dobiti u više pošiljki. Nakon obrade porudžbine, na
              vašu e-mail adresu stići će obaveštenje o statusu porudžbine.
            </p>
            <p className="font-light mt-[30px] text-[15px]">
              Po Zakonu o zaštiti potrošača, član 32 – Trgovac je dužan da u
              roku od 30 dana od dana zaključenja ugovora na daljinu i ugovora
              koji se zaključuje izvan poslovnih prostorija izvrši isporuku
              robe. Okvirni rok isporuke je do 3 radna dana. Rok isporuke može
              biti i duži od navedenog (3 radna dana), u vanrednim slučajevima
              poput velikih gužvi, pandemija, neprohodnosti puteva u slučaju
              vremenskih nepogoda i sl. Kurirska služba je u obavezi da isporuku
              vrši što efikasnije u skladu sa svojim mogućnostima i poslovnim
              kapacitetima.
            </p>
          </div>
        </div>
