            ...
            {loadingBasicData ? (
              ...
              <>
                ...
                >
                  ...
                  <div
                    className={`${
                      data?.basic_data?.gallery?.length > 0 ? `block` : `hidden`
                    }
                `}
                  >
                    <Swiper
            ...
            >
              {loadingThumb ? (
                ...
                data?.thumb?.map((thumb) => {
                  return (
                    <div
                      className={`col-span-1 flex flex-col items-center justify-center p-5 gap-3 border border-croonus-3 rounded-2xl`}
                    >
                      {thumb?.name && (
                        <Link href={`${thumb?.url}`}>
                          {" "}
