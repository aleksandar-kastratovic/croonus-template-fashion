  ...
  return (
    <div className="mt-[1.2rem] md:mt-[9rem] max-md:w-[95%] mx-auto md:w-[60%]">
      ...
      <p>
        ...
        <br />
        Ukoliko ste nakon prijema artikla utvrdili da Vam artikal iz bilo kog
        razloga ne odgovara, tada postupite po uputstvu za{" "}
        <Link href="/zamena-za-isti-artikal">ZAMENU ARTIKLA.</Link>
      </p>
      <p>
        Ukoliko želite da podnesete reklamaciju za artikal koji ste kupili{" "}
        <strong>u maloprodajnom objektu</strong>
        <strong>&nbsp;na&scaron;ih partnera</strong>, neophodno je da sa
        fiskalnim računom ili drugim dokazom o kupovini, i artiklom koji
        reklamirate, odete u maloprodajni objekat gde ste obavili kupovinu
        &ndash; u prodavnici ćete dobiti detaljna uputstva i pomoć oko
        podno&scaron;enja reklamacije.
      </p>
      <h5>
        <strong>
      ...
      <p>
        Ovaj Pravilnik stupa na snagu 11.08.2019.
        <br />
        Poslednja izmena 13.08.2022
      </p>
    </div>
  );
};
