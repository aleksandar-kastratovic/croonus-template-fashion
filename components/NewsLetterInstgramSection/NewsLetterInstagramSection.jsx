            ...
            <div className='self-center'>
                ...
                <form className='relative w-full'>
                    ...
                    <button className='absolute right-3 top-1/2 -translate-y-1/2 z-10' type='button'>
                        <Image src={'/send.png'} width={28} height={34} alt='send' />
                    </button>
                </form>
                ...
                <div className='flex items-center gap-7'>
                    <Image src={'/app-store.png'} width={120} height={40} alt='app-store' />
                    <Image src={'/google-play.png'} width={120} height={40} alt='google-play' />
                </div>
