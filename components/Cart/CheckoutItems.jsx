...
const CheckoutItems = ({
  ...
  return (
    <>
      <div
        className={`relative items-start justify-start grid grid-cols-[30%_1fr] xl:grid-cols-[25%_1fr] gap-5`}
      >
        <button
        ...
        <Link href={`/${slug_path}`} className="w-full">
          <Image
            ...
            height={0}
            sizes={`90vw`}
            className={`h-52 w-full object-cover hover:object-contain bg-gray-100`}
          />
        </Link>
        <div
