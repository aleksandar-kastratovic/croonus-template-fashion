              ...
              <div className={`flex flex-col gap-3`}>
                ...
                >
                  ...
                  >
                    {" "}
                    <button
                      className={`px-4 py-2 w-full max-md:mt-2 max-md:text-center max-md:justify-center bg-black text-white flex items-center gap-3 rounded-md hover:bg-[#04b400] transition-all duration-500`}
                    >
